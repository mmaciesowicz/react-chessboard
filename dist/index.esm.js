...
const ChessboardProvider = forwardRef(({ allowDragOutsideBoard = true, animationDuration = 300, areArrowsAllowed = true, arePiecesDraggable = true, arePremovesAllowed = false, autoPromoteToQueen = false, boardDimensions = { rows: 8, columns: 8 }, boardOrientation = "white", boardWidth, children, clearPremovesOnRightClick = true, customArrows, customArrowColor = "rgb(255,170,0)", customBoardStyle, customNotationStyle, customDarkSquareStyle = { backgroundColor: "#B58863" }, customDropSquareStyle = {
    ...
    const [currentPosition, setCurrentPosition] = useState(convertPositionToObject(position, boardDimensions));
...
function Piece({ isPremovedPiece = false, piece, square, squares, }) {
    ...
    return (jsx("div", Object.assign({ ref: arePiecesDraggable && canDrag ? drag : null, onClick: () => onPieceClick(piece, square), "data-piece": piece, style: pieceStyle }, { children: typeof chessPieces[piece] === "function" ? (chessPieces[piece]({
            ...
            isDragging,
            square,
        })) : (jsx("svg", Object.assign({ viewBox: "1 1 43 43", width: squareWidth, height: squareWidth, style: { display: "block" } }, { children: jsx("g", { children: chessPieces[piece] }) }))) })));
}
...
function Squares() {
    ...
    return (jsx("div", Object.assign({ "data-boardid": id }, { children: [...Array(boardDimensions.rows)].map((_, r) => {
...
const Arrows = () => {
    ...
    return (jsx("svg", Object.assign({ width: boardWidth, height: boardHeight, style: {
            position: "absolute",
            top: "0",
            left: "0",
            pointerEvents: "none",
            ...
            return (jsxs(Fragment$1, { children: [jsx("marker", Object.assign({ id: `arrowhead-${i}`, markerWidth: "2", markerHeight: "2.5", refX: "1.25", refY: "1.25", orient: "auto" }, { children: jsx("polygon", { points: "0.3 0, 2 1.25, 0.3 2.5", fill: arrowColor !== null && arrowColor !== void 0 ? arrowColor : primaryArrowCollor }) })), jsx("line", { x1: from.x, y1: from.y, x2: end.x, y2: end.y, opacity: isArrowActive ? "0.5" : "0.65", stroke: arrowColor !== null && arrowColor !== void 0 ? arrowColor : primaryArrowCollor, strokeWidth: isArrowActive ? 0.9 * squareWidth / 5.5 : squareWidth / 5.5, markerEnd: `url(#arrowhead-${i})` })] }, `${arrowStartField}-${arrowEndField}${isArrowActive ? "-active" : ""}`));
        }) })));
};
...
function PromotionOption({ option }) {
    ...
    return (jsx("div", Object.assign({ onClick: () => {
            ...
            transition: "all 0.1s ease-out",
                ...
                isDragging: false,
            }) }))) : (jsx("svg", Object.assign({ viewBox: "1 1 43 43", width: boardWidth / boardDimensions.columns, height: boardWidth / boardDimensions.columns, style: {
                transition: "all 0.1s ease-out",
                transform: isHover ? "scale(1)" : "scale(0.85)",
...
function Board() {
    ...
    return boardWidth ? (jsx("div", Object.assign({ style: { perspective: "1000px" } }, { children: jsxs("div", Object.assign({ ref: boardRef, style: Object.assign(Object.assign({ position: "relative" }, boardStyles(boardWidth, boardHeight)), customBoardStyle) }, { children: [jsx(Squares, {}), jsx(Arrows, {}), showPromoteDialog && (jsxs(Fragment, { children: [jsx("div", { onClick: () => {
                                setShowPromoteDialog(false);
...
function CustomDragLayer({ boardContainer }) {
    ...
    return isDragging && item.id === id ? (jsx("div", Object.assign({ style: {
            ...
            top: 0,
                ...
                squareWidth,
                isDragging: true,
            })) : (jsx("svg", Object.assign({ viewBox: "1 1 43 43", width: squareWidth, height: squareWidth }, { children: jsx("g", { children: chessPieces[item.piece] }) }))) })) }))) : null;
}
