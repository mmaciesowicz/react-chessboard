import { BoardDimensions, BoardOrientation, BoardPosition, Square } from "./types";
/**
 * Retrieves the coordinates at the centre of the requested square, relative to the top left of the board (0, 0).
 */
export declare function getRelativeCoords(boardDimensions: BoardDimensions | undefined, boardOrientation: BoardOrientation, boardWidth: number, square: Square): {
    x: number;
    y: number;
};
/**
 ...
 */
export declare function convertPositionToObject(position: string | BoardPosition, boardDimensions?: BoardDimensions): BoardPosition;
